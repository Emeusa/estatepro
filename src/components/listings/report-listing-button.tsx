...
function ReportIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={className ?? "h-4 w-4 fill-current"}>
      <path d="M5.75 3.25a.9.9 0 0 1 .9.9v.48c1.23-.42 2.43-.63 3.6-.63 1.2 0 2.42.25 3.67.76 1.02.42 1.92.63 2.71.63.58 0 1.12-.1 1.64-.29a.9.9 0 0 1 1.23.84v8.3a.9.9 0 0 1-.57.84c-.72.28-1.48.42-2.28.42-1.2 0-2.42-.25-3.67-.76-1.02-.42-1.92-.63-2.71-.63-1.12 0-2.32.3-3.62.9v5.83a.9.9 0 0 1-1.8 0V4.15a.9.9 0 0 1 .9-.9Z" />
    </svg>
  );
}
