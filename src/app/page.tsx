...
export default async function HomePage({ searchParams }: Props) {
  ...
  const currentPage = getHomepagePage(params);
  ...
  if (currentPage > listings.pagination.totalPages && listings.pagination.totalItems > 0) {
    notFound();
  }
    ...
    <div className="space-y-8">
      ...
      >
        <ListingGrid
          ...
          pagination={{ ...listings.pagination, basePath: "/", fragment: "search-results" }}
        />
      </section>
    </div>
  );
